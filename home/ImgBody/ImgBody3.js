          ...
          <div className="dfdf">
            <div className="picture-collage" >
              <div className="picture-collage-row medium"  style={{margin:"auto"}}>
                  <div className="picture-collage-item popup-picture-trigger" style={{width:"744px", height:"372px"}}>
                ...
                <div className="picture-collage-row medium"  style={{margin:"auto", marginTop:"5px"}}>
